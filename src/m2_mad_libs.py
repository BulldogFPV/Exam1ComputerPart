...
def main():
    ...
    word_noun = get_word('noun')
    word_verb = get_word('verb ending in -ing')
    word_adjective = get_word('adjective')
    print(f'This semester, I hope to join a {word_noun} and go {word_verb}. It is going to be a(n) {word_adjective} semester!')
main()